...
export default class RemoteServices {
  ...
  static async getVolunteerProfile(userId: number): Promise<VolunteerProfile>{
    return httpClient
    .get(`/profile/volunteer/${userId}`)
    .then((response) => {
      return new VolunteerProfile(response.data);
    })
    .catch(async (error) => {
  ...
  static async getInstitutionActivitySuggestions(institutionId: number | null ): Promise<ActivitySuggestion[]> {
    return httpClient
  ...
  static async registerActivitySuggestion(institutionId: number, activitySuggestion: ActivitySuggestion) {
    return httpClient
  ...
  static async approveActivitySuggestionReview(activitySuggestionId: number) {
    return httpClient
  ...
  static async rejectActivitySuggestionReview(activitySuggestionId: number) {
    return httpClient
