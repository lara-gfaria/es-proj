    ...
    public boolean hasPermission(Authentication authentication, Object targetDomainObject, Object permission) {
        ...
        if (targetDomainObject instanceof Integer) {
            ...
            switch (permissionValue) {
                ...
                case "SUGGESTION.REVIEWER":
                    ActivitySuggestion suggestion = activitySuggestionRepository.findById(id).orElse(null);
                    if (suggestion == null) return false;
                    return suggestion.getInstitution().getId().equals(((Member)authUser.getUser()).getInstitution().getId());
                default:
                    return false;
            }
        }
